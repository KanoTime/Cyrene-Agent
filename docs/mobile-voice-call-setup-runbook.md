...
1. 点击“呼叫 Cyrene”，确认桌面在线时进入连接状态；
2. 新建一段空标题对话，完成第一轮问答；
3. 连续完成至少 5 轮，持续超过 60 秒；
4. 验证回答后会回到聆听，不自动挂断；
5. 挂断并彻底退出 App；
6. 重新呼叫，选择上一段历史，询问上一轮内容；
7. 重命名该历史；
8. 挂断后删除该历史，重新进入确认没有恢复；
9. 切到“手动轮次”，未开始时播放旁人语音，确认不会进入 ASR；
10. 开始说话、提交本轮，确认能正常回答；
11. 连接蓝牙耳机，在角色说话时切换蓝牙与扬声器，确认路由按钮有效；
12. 短暂切换 Wi-Fi/移动网络，确认重连成功或明确结束，不永久卡在假通话状态。
