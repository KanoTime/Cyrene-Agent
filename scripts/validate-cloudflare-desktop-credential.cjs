...
const configuredOrigin = process.env.CYRENE_CONTROL_PLANE_ORIGIN?.trim();
if (!configuredOrigin) {
  throw new Error("CYRENE_CONTROL_PLANE_ORIGIN_REQUIRED");
}
const EXPECTED_ORIGIN = new URL(configuredOrigin).origin;
